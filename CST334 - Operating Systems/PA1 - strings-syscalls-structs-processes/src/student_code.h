...
typedef struct Group {
    ...
    char* group_name; // todo: Make a field to name the group called "group_name"
    struct Person *group_members[GROUP_MAX_SIZE]; // todo: Make a field to store up to GROUP_MAX_SIZE people called "group_members"
    int num_members; // todo: Make a field to track how many members we have called "num_members"
} Group;
